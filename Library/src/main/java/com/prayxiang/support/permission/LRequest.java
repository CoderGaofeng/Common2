...
import com.prayxiang.support.permission.checker.StrictChecker;
...
class LRequest implements Request {
    ...
    private static final com.prayxiang.support.permission.checker.PermissionChecker CHECKER = new StrictChecker();
