...
import com.prayxiang.support.router.exception.NotFoundException;
import com.prayxiang.support.router.extras.ActionRouteBundleExtras;
import com.prayxiang.support.router.extras.ActivityRouteBundleExtras;
import com.prayxiang.support.router.extras.RouteBundleExtras;
import com.prayxiang.support.router.interceptors.RouteInterceptor;
import com.prayxiang.support.router.module.RouteCreator;
import com.prayxiang.support.router.route.ActionRoute;
import com.prayxiang.support.router.route.ActivityRoute;
import com.prayxiang.support.router.route.BrowserRoute;
import com.prayxiang.support.router.route.IActionRoute;
import com.prayxiang.support.router.route.IActivityRoute;
import com.prayxiang.support.router.route.IBaseRoute;
import com.prayxiang.support.router.route.IRoute;
import com.prayxiang.support.router.route.RouteCallback;
...
public final class Router {
    ...
    public static  <T extends Activity> void registerDefaultWebClient(Class<T> clz) {
        BrowserRoute.getInstance().registerDefaultWebClient(clz);
    }
     ...
     *
     * @return An IRoute object.it will be {@link BrowserRoute}, {@link ActivityRoute} or {@link ActionRoute}.<br>
